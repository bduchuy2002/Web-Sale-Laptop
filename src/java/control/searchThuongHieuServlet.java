 ...
 * @author PC
 */
@WebServlet(name = "searchThuongHieuServlet", urlPatterns = {"/searchThuongHieuServlet"})
public class searchThuongHieuServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String ma_san_pham = request.getParameter("ma_danh_muc");   
        
        ProductDAOImp1 sanphamDAO = new ProductDAOImp1();
        String txtSearch = request.getParameter("txt");
        List<SanPham> listSearch = sanphamDAO.searchByNameThuongHieu(txtSearch, "102");
...
//        List<DanhMuc> list1 = dm1.getListDanhMucCon(ma_danh_muc_cha);
        ...
        request.getRequestDispatcher("thuonghieu.jsp").forward(request, response);
