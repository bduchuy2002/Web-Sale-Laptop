...
public class HoaDon {
    ...
    public HoaDon(String ma_hoa_don, TaiKhoan tai_khoan, String dia_chi_giao_hang, String phuong_thuc_thanh_toan, Timestamp ngay_mua_hang, Timestamp ngay_giao_hang) {
